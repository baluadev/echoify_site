      ...
      <div className="overflow-hidden">
        <div className="flex gap-6 overflow-x-auto pb-6 snap-x snap-mandatory scrollbar-hide">
          {screenshots.map((screenshot, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl p-4 shadow-2xl border border-gray-200">
                <div className="aspect-[9/19] bg-white rounded-2xl flex items-center justify-center border border-gray-200">
